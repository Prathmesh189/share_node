...
var createUser = function createUser(req, res) {
  var errors, _req$body2, name, Email, phone, password, existingUser, hashedPassword, newUserEntry;
  ...
  return regeneratorRuntime.async(function createUser$(_context3) {
    while (1) {
      switch (_context3.prev = _context3.next) {
        ...
        case 3:
          _context3.prev = 3;
          _req$body2 = req.body, name = _req$body2.name, Email = _req$body2.Email, phone = _req$body2.phone, password = _req$body2.password;
